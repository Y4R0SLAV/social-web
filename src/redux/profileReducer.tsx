...
type ActionsType = AddPostActionType |  DeletePostActionType | SetUserProfileActionType | SetStatusActionType | SetPhotoActionType
...
export const setProfileData = (profile: ProfileType): ThunkType => async (dispatch) => {
